export default function Music () {
	return (
		<div className={`absolute opacity-75 w-full left-0 top-0 p-4 px-8 pr-80 pb-40 bg-black`}>
			<div className="flex justify-center items-center h-full py-8">
	            <p className="text-7xl font-extrabold text-stone-800 font-horsePuke">play music</p>
	          </div>
