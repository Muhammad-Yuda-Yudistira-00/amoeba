...
export default function ChecklistClient({initialData, code, activePage}: {initialData: Checklist, code: string, activePage?: number}){
	...
	return (
		<div className="flex flex-row-reverse w-screen h-full justify-between md:justify-end bg-yellow-900 mb-12">
			<div className="text-center py-4 flex flex-col items-center border-x-2 bg-[url('/themes/patterns/circle-blues.webp')]">
			...
			<div className="flex flex-col w-full items-center min-h-screen bg-stone-800 py-2 pt-4 px-0 md:px-8 md:w-4/5 py-10 bg-[url('/themes/patterns/mosaic.webp')] bg-blend-luminosity">
				<div className="flex flex-col justify-between items-center h-full">
					...
					<div className="h-2/12 text-center w-2/3 bg-gradient-to-r from-white/20 via-stone-800 to-stone-400 mt-4 mb-8">
