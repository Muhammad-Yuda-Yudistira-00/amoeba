...
const Footer: React.FC<FooterProps> = ({expiredAt, code, setChecklist}) => {
	...
	return(
		<footer className="py-2 px-2">
			<div>
				<p className="text-stone-800 font-kingthingsXstitch">Your checklist active still in <span className="text-yellow-800 font-bold text-sm md:text-lg">{expire} / 30</span> days.</p>
			</div>
			<div>
