...
export default function Sidebar() {
	return(
		<div className="w-screen md:w-1/6 bg-amber-200 flex flex-col-reverse justify-end items-center relative md:z-20 bg-[url('/themes/patterns/cork-board.webp')] bg-blend-multiply">
			<Link href="/">
				<div className="hover:brightness-75 brightness-95 border-black border-2 border-b-0 px-1 md:px-1 py-2 md:py-4 text-center text-sm md:text-lg fixed top-[145px] right-0 md:top-auto md:bottom-0 md:right-3 w-32 md:w-48 bg-[url('/themes/patterns/metallic-holographic.webp')] bg-blend-color-burn bg-red-500 group rounded-t-lg">
