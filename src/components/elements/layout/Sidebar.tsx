...
export default function Sidebar() {
	return(
		<div className="w-screen md:w-1/6 bg-indigo-700 flex flex-col-reverse justify-end items-center relative md:z-20 selection:bg-orange-600">
			<Link href="/">
				<div className="hover:brightness-75 brightness-95 border-black border-2 border-b-0 px-1 md:px-1 py-2 md:py-4 text-center text-sm md:text-lg fixed top-[175px] right-0 md:top-auto md:bottom-0 md:right-3 w-32 md:w-48 bg-green-400 group rounded-t-lg">
			...
			<div className="h-[180px] md:h-full w-full md:flex md:justify-center">
				<div className="h-[200px] w-[180px] fixed md:block left-0 md:top-0 md:left-auto md:bg-white/20 md:pt-8">
					<Image src="/themes/background/shoes-girl.jpg" alt="logo" width={180} height={180} title="Touch Me !!" priority className="" />
				</div>
