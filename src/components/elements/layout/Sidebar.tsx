...
export default function Sidebar() {
	return(
		<div className="w-screen md:w-1/6 bg-stone-700 flex flex-col-reverse justify-end items-center relative md:z-20 bg-[url('/themes/background/accent-bg.jpg')] bg-cover">
			<Link href="/">
