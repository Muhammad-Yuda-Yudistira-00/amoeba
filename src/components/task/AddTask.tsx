			...
			<form onSubmit={handleSubmit}>
				<div className="flex items-center bg-black px-4 py-2">
					<div className="md:mr-4 w-full">
						<input type="text" name="task" value={task} onChange={handleChange} placeholder="write your ide.." className="px-2 font-bold text-sm rounded-l-2xl pl-4 text-white focus:outline-yellow-600 focus:ring-yellow-600 focus:border-yellow-600 h-5 md:h-6 w-full bg-stone-700" />
					</div>
