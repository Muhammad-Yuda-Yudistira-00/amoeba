    ...
    <div className="flex flex-col items-center gap-6 pt-2 pb-4 bg-[url('/themes/background/girls.svg')] bg-cover bg-center w-full h-full">
      <div className="flex flex-col gap-6 md:gap-12 pt-8">
        <div className="text-center md:px-10">
          <h1 className="text-4xl md:text-5xl font-extrabold dark:text-neutral-800 uppercase bg-white/10">{appName}<small className="text-lg md:text-4xl ms-2 font-semibold text-white dark:text-orange-700 lowercase bg-orange-200/40 px-2"> task manager or todolist</small></h1>
